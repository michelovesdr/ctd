class TicTacToe
    ...
    def check_victory
        ...
        if @board.winning_combination?(@current_player.piece)
            ...
            puts "Congratulations #{@current_player.name}, youre the winner!"
            true
        else
            false
        end
...
class Player
    ...
    def ask_for_coordinates
        ...
        puts "#{@name}(#{@piece}), enter your coordinates in the form x,y, (numbers 0-2, and no letters):"
    ...
    def validate_coordinates_format(coords)
        ...
        if coords.is_a?(Array) && coords.size == 2
            ...
            puts "letters are not acceptable"
            puts "please include a number 0-2"
...
class Board
    ...
    def within_valid_coordinates?(coords)
        ...
        if (0..2).include?(coords[0]) && (0..2).include?(coords[1])
            ...
            puts "Remember put a number 0-2 only"
        end
    end
    ...
    def coordinates_available?(coords)
        ...
        if @board[coords[0]][coords[1]].nil?
            ...
            # display error message
            puts "There is already something there!"
        end
    end
